...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vehicle_type', models.CharField(choices=[('MOTORHOME', 'Motorhome'), ('RV_CLASS_A', 'RV - Class A'), ('RV_CLASS_B', 'RV - Class B'), ('RV_CLASS_C', 'RV - Class C'), ('TRUCK_CAMPER', 'Truck Camper'), ('VAN', 'Van'), ('OTHER', 'Other')], max_length=20)),
                ('make', models.CharField(max_length=100)),
                ('model', models.CharField(max_length=100)),
                ('year', models.PositiveIntegerField()),
                ('length', models.DecimalField(decimal_places=2, help_text='Length in feet', max_digits=5)),
